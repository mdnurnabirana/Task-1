  ...
  return (
    <div className="flex flex-col">
      <div className="bg-white rounded-2xl sm:rounded-3xl p-2 relative">
        ...
        />
        <span className="bg-[#4A69E2] rounded-tl-xl sm:rounded-tl-2xl rounded-br-[14px] sm:rounded-br-3xl px-2 sm:px-4 py-1 sm:py-3 text-white font-semibold text-xs absolute top-2">New</span>
      </div>

      <h1 className="font-semibold text-[16px] text-xl mt-3 uppercase line-clamp-2">{title}</h1>
